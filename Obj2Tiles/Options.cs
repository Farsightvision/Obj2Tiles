...
public sealed class Options
{
    ...
    // --- HLOD-profile overrides ---
    // Passing --hierarchical-lods selects the HLOD profile, which defaults
    // quantize-glbs / meshopt-compress / leaf-no-mips ON and adaptive-extend OFF
    // (KTX2 is already ON by default). These flags let an operator override each
    // individually. They have NO effect on the flat (non-hierarchical) pipeline.
